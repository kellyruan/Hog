...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    player_abs = abs(player_score % 10 - player_score % 100 // 10)
    oppenent_abs = abs(opponent_score % 10 - opponent_score % 100 // 10)
    if player_abs == oppenent_abs:
        return True
    else:
        return False
    # END PROBLEM 4
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        ...
        if who == 0:
            if score0 - new_score > new_high:
                new_high = score0 - new_score
                print (new_high, "point(s)! That's the biggest gain yet for Player", who)
            new_score = score0
        elif who == 1:
            if score1 - new_score > new_high:
                new_high = score1 - new_score
                print (new_high, "point(s)! That's the biggest gain yet for Player", who)
            new_score = score1
...
def bacon_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 10
    if 2*(opponent_score//10)-opponent_score%10 >= margin or 1 >= margin:
        return 0
    else:
        return num_rolls
    # END PROBLEM 10
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if is_swap(new_score, opponent_score) == True and score < opponent_score:
        return 0
